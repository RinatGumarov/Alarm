...
class AlarmPreferenceListAdapter(context: Context, alarm: Alarm) : BaseAdapter(), Serializable {
    ...
    fun getAlarm(): Alarm {
        for (preference in preferences) {
            when (preference.key) {
                AlarmPreference.Key.ALARM_ACTIVE -> alarm!!.isAlarmActive = preference.value as Boolean
                AlarmPreference.Key.ALARM_NAME -> alarm!!.alarmName = preference.value as String
                AlarmPreference.Key.ALARM_TIME -> alarm!!.setAlarmTime(preference.value as String)
                AlarmPreference.Key.ALARM_TONE -> alarm!!.alarmTonePath = preference.value as String
                AlarmPreference.Key.ALARM_VIBRATE -> alarm!!.isVibrate = preference.value as Boolean
                AlarmPreference.Key.ALARM_REPEAT -> alarm!!.days = preference.value as Array<Alarm.Day>
            }
        }
